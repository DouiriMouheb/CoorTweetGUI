    ...
    <div>
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        type in your email address and we will send you a link
      ...
      <div class="flex min-h-full flex-col justify-center px-6 py-6 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <h2 class="mt-5 text-center text-2xl/9 font-bold tracking-tight text-indigo-900">
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form class="space-y-6" onSubmit={handelSubmit}>
            <div>
              <label
                for="email"
                class="block text-sm/6 font-medium text-indigo-400"
              >
                Email address
              </label>
              <div class="mt-2">
