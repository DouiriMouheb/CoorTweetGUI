...
const NetworkScreen = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
      ...
      >
        <div className="flex items-center bg-white/90 backdrop-blur-xl rounded-full shadow-xl border border-gray-200/50 px-4 py-2 space-x-4">
          ...
          <motion.button
            ...
            whileHover={{ x: -2 }}
            whileTap={{ scale: 0.95 }}
            className="flex items-center text-gray-600 hover:text[#00926c] transition-colors"
          >
          ...
          >
            <div className="relative">
              <div className="absolute -inset-1 bg-[#00926c/50] blur rounded-full" />
              <CpuChipIcon className="w-5 h-5 text-[#00926c]" />
            </div>
      ...
      <div className="pt-20">
        {/* Main Visualization */}
        <div className="relative h-[70vh] w-full bg-gradient-to-br from-gray-50 to-blue-50">
          {loading ? (
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-[#00926c]" />
            </div>
          ) : network ? (
            <motion.div
              initial={{ opacity: 0 }}
                ...
                return (
                  <button
                    ...
                    className={`px-8 py-4 flex items-center space-x-2 transition-colors
                      ${
                        activeTab === tab.id
                        ? "text-[#00926c] border-b-2 border-[#00926c] bg-[#00926c]/10"
                        : "text-[#3d3d3c] hover:text-[#00926c] hover:bg-[#ffffff]/20"
...
{activeTab === 3 && (
                  <div className="overflow-x-auto rounded-lg shadow-inner">
                     <ClusterTable mode="object" networkData={network} loading={loading} />
                        </div>
                )}
                    ...
                    <div className="grid grid-cols-3 gap-6 w-full">
                      {network &&
                        ...
                        [
                          ...
                          <div
                            key={index}
                            className="p-6 bg-[#00926c] rounded-xl border border-[#00926c] w-full max-w-md"
                          >
